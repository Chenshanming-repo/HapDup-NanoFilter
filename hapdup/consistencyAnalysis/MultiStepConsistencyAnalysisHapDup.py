import gzip
import os.path
from hapdup.VCFProcess import parse_clair3_vcf_line
import  numpy as np
import logging
        ...
        for key1 in consistency_dict:
            ...
            if len(consistency_list) >= n_min_variant_position:
                ...
                if filter_not_enough_position:
                    if float(clair3_vcf_records_dict[key1].qual) < 10:
                        filtered_keys.add(key1)
...
def filter_main(VCF_FN, FRAGMENT_FN, OUTPUT_VCF, OUT_DIR, FILTER_SNP=True, ctg=None):
    ...
    # logger.info("============STEP1=============")
    filtered_keys_step1 = consistency_analysis_step_1(consistency_res_dict, N_MIN_COVERED_READS_STEP1, N_MIN_VARIANT_POSITION_STEP1, MIN_CONSISTENCY_STEP1, VCF_FN, filter_snp=FILTER_SNP)
    print(len(filtered_keys_step1))
    # logger.info("============STEP2=============")
    filtered_keys_step2 = consistency_analysis_step_2(consistency_res_dict, N_MIN_COVERED_READS_STEP2, N_MIN_VARIANT_POSITION_STEP2, MIN_CONSISTENCY_STEP2, VCF_FN, filtered_keys_step1, filter_snp=FILTER_SNP)
    print(len(filtered_keys_step2))
    # logger.info("============STEP3=============")
    filtered_keys_step3 = consistency_analysis_step_3(consistency_res_dict, N_MIN_COVERED_READS_STEP3, N_MIN_VARIANT_POSITION_STEP3, MIN_CONSISTENCY_STEP3, VCF_FN, filtered_keys_step2, filter_snp=FILTER_SNP)
    print(len(filtered_keys_step3))
...
if __name__ == '__main__':
    print("R9 raw_snp_filtered_indel")
    read_pepper_vcf("/public/home/hpc224712204/bench/hapdup_hapcut/raw_snp_filtered_indel/pepper/PEPPER_VARIANT_FULL.vcf")
    read_pepper_vcf("/public/home/hpc224712204/bench/hapdup_hapcut/raw_snp_filtered_indel/pepper/PEPPER_VARIANT_FULL.vcf.filtered")
    print("HiFi raw_snp_filtered_indel")
    read_pepper_vcf("/public/home/hpc224712204/bench/hapdup_hapcut_hifi/raw_snp_filtered_indel/pepper/PEPPER_VARIANT_FULL.vcf")
    read_pepper_vcf("/public/home/hpc224712204/bench/hapdup_hapcut_hifi/raw_snp_filtered_indel/pepper/PEPPER_VARIANT_FULL.vcf.filtered")
    print("R10 raw_snp_filtered_indel")
    read_pepper_vcf("/public/home/hpc224712204/bench/hapdup_hapcut_r10/raw_snp_filtered_indel/pepper/PEPPER_VARIANT_FULL.vcf")
    read_pepper_vcf("/public/home/hpc224712204/bench/hapdup_hapcut_r10/raw_snp_filtered_indel/pepper/PEPPER_VARIANT_FULL.vcf.filtered")

    print("\nR9 clair3")
    read_pepper_vcf("/public/home/hpc224712204/data/hg002_tag/hg002_ont_all/clair3/all_contigs.vcf.gz")
    print("HiFi clair3")
    read_pepper_vcf("/public/home/hpc224712204/data/hg002_tag/hg002_hifi/clair3/merge_output.vcf.gz")
    print("R10 clair3")
    read_pepper_vcf("/public/home/hpc224712204/data/hg002_tag/hg002_ont_r10/clair3/merge_output.vcf.gz")

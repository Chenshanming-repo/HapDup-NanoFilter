...
if __name__ == '__main__':
    DIR="/public/home/hpc224712204/bench/hapdup_GRCH38_hg002/r10_duplex/raw_snp_filtered_indel_weight_th_qual15/tmp/chr1"
    filter_main(f"{DIR}/PEPPER_VARIANT_FULL.vcf.chr1", f"{DIR}/fragment_file", f"{DIR}/PEPPER_VARIANT_FULL.vcf.chr1.filtered", DIR, FILTER_SNP=False, ctg=None)

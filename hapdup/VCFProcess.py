...
from AssemblyPhase.VariantRecord import *
from common.shared.DefaultElement import *
"""
    输入vcf绝对路径
    输出VariantRecord数组
"""
...
def parse_clair3_vcf_line(line : str, line_no : int) -> VariantRecord:
    if line.startswith("#"):
        logger.debug(f"Not a variant record line which starts with #.")
    ...
    return VariantRecord(ctg, pos, allele1, allele2, QUAL, gt, variant_type, line_no)


if __name__ == '__main__':
    read_clair3_vcf("/Users/hondor/Data/vcf_isec/0002.vcf")